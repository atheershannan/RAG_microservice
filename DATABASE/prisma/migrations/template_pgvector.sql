-- Migration: Add pgvector extension and indexes
-- This file should be used as a template for creating the pgvector migration
-- 
-- Usage:
-- 1. Create a new migration directory: mkdir -p migrations/YYYYMMDDHHMMSS_add_pgvector_extension
-- 2. Copy this file to migrations/YYYYMMDDHHMMSS_add_pgvector_extension/migration.sql
-- 3. Run: npx prisma migrate resolve --applied YYYYMMDDHHMMSS_add_pgvector_extension
