-- ============================================
-- בדיקת "Eden Levi" ב-Supabase (מתוקן ל-pgvector)
...
-- 5. בדיקת embeddings תקינים (מתוקן)
SELECT 
  content_id,
  content_type,
  CASE 
...
-- 6. בדיקה ספציפית של manager-001 (מתוקן)
SELECT 
  content_id,
  content_text,
  metadata,
...
-- 8. שאילתה פשוטה ללא בדיקת embedding (אם עדיין יש בעיות)
SELECT 
  content_id,
  content_text,
  metadata->>'fullName' as name,
